<?php 
    ...
    $query = mysqli_query($conn, "SELECT * FROM calonmurid WHERE Nama='$Nama';");
    ...
    if(isset($_POST['submit'])){
        ...
        $Telp = $_POST['Telp'];
        $Alamat = $_POST['Alamat'];
        $sql=mysqli_query($conn, "UPDATE calonmurid SET 
        Nama='$Nama', Tempatlahir='$Tempatlahir', 
        Tanggallahir='$Tanggallahir', Paket='$Paket', Email='$Email', Telp='$Telp', Alamat='$Alamat' WHERE Nama='$Nama';");
...
<body>
    ...
    <div class="isi">
        <div>
            <h1 style="font-size: 50px;"><b>Update Data Baru</b></h1><br>
            <form action="" method="POST" style="align-items: center; align-self: center; align-content: center;">
                ...
                <div class="mb-3">
                    <input class="form-control" style="padding: 15px; border-color: #7976FF; background-color: #8098f92d;" type="date" name="Tanggallahir" value="<?php echo $row['Tanggallahir']; ?>">
                </div>

                <div class="mb-3">
                    <input class="form-control" style="padding: 15px; border-color: #7976FF; background-color: #8098f92d;" type="text" name="Paket" value="<?php echo $row['Paket']; ?>">
                </div>
